...
const NEW_YEAR_FEMALE_PROMPTS: StickerPrompt[] = [
  ...
  { id: 'f_ny_8', label: '新年暴富', prompt: '角色兴奋地举着"2026暴富"的牌子，周围飘着金币和红包。'},
...
const NEW_YEAR_MALE_PROMPTS: StickerPrompt[] = [
  ...
  { id: 'm_ny_8', label: '新年暴富', prompt: '角色兴奋地举着"2026暴富"牌子跳起来，周围金光闪闪' },
...
const NEW_YEAR_DUO_PROMPTS: StickerPrompt[] = [
  ...
  { id: 'd_ny_8', label: '新年暴富', prompt: '两人一起举"暴富"牌子，眼睛发光。' },
